...
export interface Avatar {
  ...
  body_measurements?: { [key: any /* enums.MeasurementLocation */]: number /* float64 */};
}
...
export interface BaseBodyMeasurement {
  id: number /* int64 */;
  measurement_location: any /* enums.MeasurementLocation */;
  lay_flat: boolean;
...
//////////
// source: debug_size_recommendation.go
...
export interface DebugSize {
  ...
  size_garment_value: { [key: any /* enums.MeasurementLocation */]: DebugSizeGarmentValue};
}
...
export interface DebugVerticalSizeGarmentValue {
  size_id: number /* int64 */;
  size_label: string;
  value: number /* float64 */;
}
...
export interface DebugSizeRecommendation {
  ...
  sizes: DebugSize[];
  style_category_measurement_locations: any /* enums.MeasurementLocation */[];
  horizontal_measurement_locations: any /* enums.MeasurementLocation */[];
  vertical_measurement_locations: any /* enums.MeasurementLocation */[];
  measurement_location_aliases?: OrderedMap<any /* enums.MeasurementLocation */, any /* enums.MeasurementLocation */>;
  avatar_measurements: { [key: any /* enums.MeasurementLocation */]: number /* float64 */};
  deformed_avatar_measurements: { [key: any /* enums.MeasurementLocation */]: number /* float64 */};
  style_base_body_adjustments: { [key: any /* enums.MeasurementLocation */]: number /* float64 */};
  base_body_measurements_before_consensus: { [key: any /* enums.MeasurementLocation */]: DebugBaseBodyMeasurement[]};
  base_body_measurements_after_consensus: { [key: any /* enums.MeasurementLocation */]: DebugBaseBodyMeasurement};
  initial_reference_sizes: { [key: any /* enums.MeasurementLocation */]: DebugSizeGarmentValue[]};
  horizontal_garment_measurements: { [key: any /* enums.MeasurementLocation */]: DebugSizeGarmentValue[]};
  vertical_garment_measurements: { [key: any /* enums.MeasurementLocation */]: DebugVerticalSizeGarmentValue[]};
  invalid_horizontal_size_groups: any /* enums.MeasurementLocation */[];
  invalid_vertical_size_groups: any /* enums.MeasurementLocation */[];
  consensus_reference_size: DebugSize;
  flared_exception: boolean;
  relaxed_exception: boolean;
  oversized_exception: boolean;
  exception_filtered_measurement_locations: any /* enums.MeasurementLocation */[];
  horizontal_location_to_group_best_fit_for_reference_size: { [key: any /* enums.MeasurementLocation */]: DebugSizeGarmentValue};
  horizontal_location_to_group_best_fit_size_after_filter_exceptions: { [key: any /* enums.MeasurementLocation */]: DebugSizeGarmentValue};
  horizontal_location_to_best_fit_size_consensus: { [key: any /* enums.MeasurementLocation */]: DebugSizeGarmentValue};
  vertical_location_to_group_best_fit_size: { [key: any /* enums.MeasurementLocation */]: DebugVerticalSizeGarmentValue};
  vertical_location_to_best_fit_size_consensus: { [key: any /* enums.MeasurementLocation */]: DebugVerticalSizeGarmentValue};
  recommended_size: DebugSize;
  available_sizes: DebugSize[];
  size_fits: SizeFit[];
}
...
export interface MeasurementLocation {
  name: any /* enums.MeasurementLocation */;
  brand_id: number /* int64 */;
  avatar_measurement_location: any /* enums.MeasurementLocation */;
...
export interface Style {
  ...
  measurement_unit: string;
  is_published: boolean;
  placement_measurement_location: any /* enums.MeasurementLocation */;
...
export interface StyleCategory {
  ...
  name: string;
  label: string;
  measurement_locations_female: any /* enums.MeasurementLocation */[];
  measurement_locations_male: any /* enums.MeasurementLocation */[];
}
