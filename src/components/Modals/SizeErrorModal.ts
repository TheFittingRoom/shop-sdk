...
const SizeErrorModal = (props: SizeErrorModalProps): ModalContent => {
	...
	const Body = () => {
        ...
        <div class="tfr-mt-15-p tfr-mb-13-p">
            <div tfr-element="true" class="tfr-regular-20-default tfr-c-dark">
        ...
        <div class="tfr-t-a-center">
            ...
            <span id="tfr-close" tfr-element="true" class="tfr-body-font tfr-16-default tfr-c-dark-o5 tfr-underline tfr-cursor">${L.ReturnToProductPage || "Return to Product Page"}</span>
        </div>
        `;
	};
